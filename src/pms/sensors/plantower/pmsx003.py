...
class ObsData(pms3003.ObsData):
    ...
    def __format__(self, spec: Literal["pm", "raw", "cf", "num", "csv", "header"] | str) -> str:
        match spec:
            case "csv":
                pm = super().__format__(spec)
                return (
                    f"{pm}, {self.n0_3:.2f}, {self.n0_5:.2f}, "
                    f"{self.n1_0:.2f}, {self.n2_5:.2f}, {self.n5_0:.2f}, {self.n10_0:.2f}"
                )
            case "num":
                return (
                    f"{self.date:%F %T}: N0.3 {self.n0_3:.2f}, N0.5 {self.n0_5:.2f}, "
                    f"N1.0 {self.n1_0:.2f}, N2.5 {self.n2_5:.2f}, N5.0 {self.n5_0:.2f}, "
                    f"N10 {self.n10_0:.2f} #/cm3"
                )
