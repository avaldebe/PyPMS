...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            pm.HPMA115S0, "400504303156", "message length: 6 != 8", id="HPMA115S0 short message"
        ),
        pytest.param(
            pm.HPMA115S0,
            "4005040030003100",
        ...
        pytest.param(
            pm.SPS30, "7E00030028000000D47E", "message length: 10 != 47", id="SPS30 short message"
        ),
        pytest.param(
            pm.SPS30,
            "7E00030000FC7E",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            pm.SPS30.Message,
            pm.SPS30.commands.passive_read.answer_header[:1],
            pm.SPS30.commands.passive_read.answer_length,
            "wrong header length 1",
            id="SPS30 wrong header length",
        ),
        pytest.param(
            pm.SPS30.Message,
            pm.SPS30.commands.passive_read.answer_header * 2,
            pm.SPS30.commands.passive_read.answer_length,
        ...
        pytest.param(
            pm.SPS30.Message,
            pm.SPS30.commands.passive_read.answer_header,
            pm.PMSx003.commands.passive_read.answer_length,
